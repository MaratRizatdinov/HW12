...
let apiUrl = "https://webdev-hw-api.vercel.app/api/v1/marat-rizatdinov/comments";
import { renderComment } from "./render.js";
import { getDataFromAPI, postDataToAPI } from "./api.js";
...
function reload() {
    ...
    .then((responseData) => {  
          ...
          renderComment(listElement, arrayOfComments);
...
function postAndGetComments() {
  ...
  postDataToAPI (apiUrl, commentInputElement, nameInputElement)
